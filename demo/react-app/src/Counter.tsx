...
//todo this file is old to delete 
export function Counter({ id }: { id: string }) {
  ///let nc = useNetworkVariable("config") //
  // console.log(nc);
  // let netconfig = nc as unknown as NetworkConsts;
  //as unknown as NetworkConsts
  const counterPackageId = "";//netconfig.package_id;
