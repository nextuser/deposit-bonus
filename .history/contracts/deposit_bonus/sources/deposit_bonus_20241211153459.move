...
fun add_money_to_share(storage :& Storage, money : u64) : u64{
...
fun update_user_share(storage :&mut Storage, original_money :u64,share_amount:u64,time_ms : u64,sender : address){
