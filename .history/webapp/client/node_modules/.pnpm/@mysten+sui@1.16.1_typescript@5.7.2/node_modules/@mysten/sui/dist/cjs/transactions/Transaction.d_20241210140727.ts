...
import type { SuiClient } from '.pnpm/@mysten+sui@1.16.1_typescript@5.7.2/node_modules/@mysten/sui/dist/cjs/client/index.js';
import type { SignatureWithBytes, Signer } from '.pnpm/@mysten+sui@1.16.1_typescript@5.7.2/node_modules/@mysten/sui/dist/cjs/cryptography/index.js';
import type { TransactionArgument } from '.pnpm/@mysten+sui@1.16.1_typescript@5.7.2/node_modules/@mysten/sui/dist/cjs/transactions/Commands.js';
import type { CallArg, Command } from '.pnpm/@mysten+sui@1.16.1_typescript@5.7.2/node_modules/@mysten/sui/dist/cjs/transactions/data/internal.js';
import { Argument, ObjectRef, TransactionExpiration } from '.pnpm/@mysten+sui@1.16.1_typescript@5.7.2/node_modules/@mysten/sui/dist/cjs/transactions/data/internal.js';
import { Inputs } from '.pnpm/@mysten+sui@1.16.1_typescript@5.7.2/node_modules/@mysten/sui/dist/cjs/transactions/Inputs.js';
import type { BuildTransactionOptions, SerializeTransactionOptions, TransactionPlugin } from '.pnpm/@mysten+sui@1.16.1_typescript@5.7.2/node_modules/@mysten/sui/dist/cjs/transactions/json-rpc-resolver.js';
import { createPure } from '.pnpm/@mysten+sui@1.16.1_typescript@5.7.2/node_modules/@mysten/sui/dist/cjs/transactions/pure.js';
...
export declare class Transaction {
    ...
    get blockData(): {
        ...
        transactions: ({
            ...
            type: {
                Some: import(".pnpm/@mysten+sui@1.16.1_typescript@5.7.2/node_modules/@mysten/sui/dist/cjs/bcs/types.js").TypeTag;
            } | {
                None: true | null;
            };
            kind: "MakeMoveVec";
    ...
    getData(): {
        ...
        commands: import("@mysten/bcs").EnumOutputShapeWithKeys<{
            MoveCall: {
                ...
                _argumentTypes?: {
                    ref: "&" | "&mut" | null;
                    body: import(".pnpm/@mysten+sui@1.16.1_typescript@5.7.2/node_modules/@mysten/sui/dist/cjs/transactions/data/internal.js").OpenMoveTypeSignatureBody;
                }[] | null | undefined;
            };
            TransferObjects: {
                address: {
