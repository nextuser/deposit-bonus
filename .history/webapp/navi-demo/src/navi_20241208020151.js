...
import {NAVISDKClient} from 'navi-sdk-dev'
dotenv.config();
...
client.getPoolInfo(USDT).then(get_promp_print('USDT pool info'))

//client.getReserveDetail(Sui).then(get_promp_print('sui reserve details'));
//client.getReserveDetail(USDT).then(get_promp_print('usdc reserve detials'))
