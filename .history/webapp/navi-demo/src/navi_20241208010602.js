...
account.getNAVIPortfolio(new_address,true).then(console.log);
console.log("---------health factor--------");
account.getHealthFactor(new_address).then(console.log);

let new_address  = "0xafe36044ef56d22494bfe6231e78dd128f097693f2d974761ee4d649e61f5fa2"
console.log("---------getAddressAvailableRewards--------");
client.getAvailableRewards(new_address,  1).then(console.log);
